...
# -------- wlcf --------
def wlcf_Bells(ellmin, ellmax, chiQuadSteps, Nell, zbin, mMax,
...
def main():
    ap = argparse.ArgumentParser(description="3pcf angular correlation modeling with wlcf.")
    ...
    ap.add_argument("--ellmax", type=float, default=10000.0)
    ap.add_argument("--ellmin", type=float, default=0.001)
