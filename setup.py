...
liblist = ["wlcf","gsl","gslcblas","fftw3"]
#
...
wlcfpy_ext = Extension("wlcfpy", [os.path.join(wlcfpy_folder, "wlcfpy.pyx")],
...
import sys
wlcfpy_ext.cython_directives = {'language_level': "3" if sys.version_info.major>=3 else "2"}

setup(
    name='wlcfpy',
    version=VERSION,
    description='Python interface to the nPCF code wlcf',
